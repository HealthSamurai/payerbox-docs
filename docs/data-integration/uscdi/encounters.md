...
| `participant_npi` | If available | 10 digits, Luhn-valid over the `80840` prefix, `;`-separated | `9999999995` |
...
| `service_provider_npi` | If available | 10 digits, Luhn-valid over the `80840` prefix | `9999999979` |
...
{% file src="../../assets/data-integration/locations.d63e450b.csv" %}
...
| `managing_org_npi` | Recommended | 10 digits, Luhn-valid over the `80840` prefix | `9999999979` |
