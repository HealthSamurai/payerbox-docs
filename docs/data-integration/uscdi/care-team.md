...
| `specialty_nucc` | Recommended | NUCC taxonomy code(s), `;`-separated [Healthcare Provider Taxonomy](https://tx.fhir.org/r4/ValueSet/2.16.840.1.114222.4.11.1066-20240606?_format=html) | `207R00000X` |
| `primary_org_npi` | Recommended | 10 digits | `1234567893` |
| `practitioner_role_code` | Recommended | role code [Care Team Member Function](https://tx.fhir.org/r4/ValueSet/2.16.840.1.113762.1.4.1099.30-20240605?_format=html) | `doctor` |
...
| `role_code` | Yes | SNOMED or NUCC code [Care Team Member Function](https://tx.fhir.org/r4/ValueSet/2.16.840.1.113762.1.4.1099.30-20240605?_format=html) | `223366009` |
