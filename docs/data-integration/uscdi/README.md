...
| 5 | `locations` | derived from the addresses on [Encounter Information](encounters.md#where-the-encounter-happened), or from [Provider Directory](../provider-directory/README.md#facilities) | Location |
