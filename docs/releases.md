...
- Added the [`$davinci-data-export`](api-reference/operations/davinci-data-export.md) operation (`provider-download` type): a consent-aware export that excludes pharmacy/drug data.
