...
| Da Vinci Documentation Templates and Rules (DTR) | STU 2.0.0 | [hl7.org/fhir/us/davinci-dtr/STU2](https://hl7.org/fhir/us/davinci-dtr/STU2/) | DTR |
...
> TODO(engineering): populate per-release changes. Each Payerbox release that bumps an IG version lists the change here with link to the Release Notes entry.

## Version pinning policy

Payerbox aligns by default with the versions CMS lists as recommended. Customers who need to support an alternate IG version for a specific use case can run an alternate validator profile — see [Run Payerbox / Configure](../run-payerbox/deploy.md).
